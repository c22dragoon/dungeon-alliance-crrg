...
For greater challenge in solo/cooperative game players can play the Nightmare Mode, which forces you to delay the flipping of the top card of the Solo/Cooperative Deck until the start of Monster Activation. 

\related{sec:SoloCooperative}
...
\newreference{Solo/Cooperative}{sec:SoloCooperative}
TBD
